          ...
          <div id="primary" class="content-area">
            ...
            <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
              ...
              <div class="post-content">
                ...
                <?php
                /* Career Type */
                  $careertype = new WP_Query( array( 'post_type' => 'careers', 'posts_per_page' => '1' ) );

                  if ( $careertype->have_posts() ) :

                    while ( $careertype->have_posts() ) : $careertype->the_post();

                        // get all of the terms for this post, with the taxonomy of categories-projets.
                        $terms = get_the_terms( $post->ID, 'career-type' );
                  ...
                  $incomerange = new WP_Query( array( 'post_type' => 'careers', 'posts_per_page' => '1' ) );

                  if ( $incomerange->have_posts() ) :

                    while ( $incomerange->have_posts() ) : $incomerange->the_post();

                        // get all of the terms for this post, with the taxonomy of categories-projets.
                        $terms = get_the_terms( $post->ID, 'income-range' );

                        foreach ( $terms as $term ) {
                            echo '<br /><b>Income Range:</b> '.$term->name." ";
                        }
                        echo "</span>";
                    endwhile;
                    wp_reset_query();
                  ...
                  $location = new WP_Query( array( 'post_type' => 'careers', 'posts_per_page' => '1' ) );
